...
| 86 | `synthetic_boundary_layer_profile(z, T_surface=288.15, mixed_top=800.0, inversion_depth=200.0, inversion_dT_dz=0.01, mixed_dT_dz=-0.0098, upper_dT_dz=-0.0045)` · `synthetic_boundary_layer_column(z, …same…, p_surface, p_ref, cp, R, g, gamma) -> dict(z, T, dT_dz, p, rho, theta, dtheta_dz, rho_theta, N2, stability)` | K · dict | §1.10 (N18) | C55 slider, E4 inversion preset | WIP · not in §4 |

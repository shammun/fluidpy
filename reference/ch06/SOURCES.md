...
|---|---|---|---|---|---|---|
| `added_mass_sphere` | M = (2/3)πr³ρ = ½ × displaced fluid mass; (m_p + ρV_p/2) dv/dt = ΣF | Wikipedia, "Added mass" | https://en.wikipedia.org/wiki/Added_mass | page read; formula and "half the volume … times the density" quoted | 2026-09-23 | V5 (coefficient ½) |
| `rayleigh_collapse` | empty-cavity filling time t ≈ 0.91468 R₀√(ρ/P∞) (Besant 1859, Rayleigh) | Wikipedia, "Rayleigh–Plesset equation" | https://en.wikipedia.org/wiki/Rayleigh%E2%80%93Plesset_equation | page read; constant quoted (5 significant figures) | 2026-09-23 | V5 (0.91468) |

...
| UNESCO EOS-80 check value 1027.67547 (S = 35, t = 5 °C, p = 0) | only a search snippet (Gill 1982 via a wiki); the primary UNESCO Tech. Pap. 44 was not fetched, so `seawater_density_eos80` is checked for self-consistency only |
